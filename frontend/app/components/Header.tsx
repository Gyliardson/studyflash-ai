...
export default function Header() {
    ...
    return (
        <header className="w-full max-w-6xl mx-auto mb-8 sticky top-4 z-50 px-4 md:px-6">
            <div className="flex justify-between items-center py-4 px-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-white/20 dark:border-slate-800 rounded-2xl shadow-sm">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {/* Divisória e Auth */}
                    <div className="pl-4 border-l border-gray-200 dark:border-slate-700 ml-2 flex items-center">
                        <SignedOut>
                            <SignInButton mode="modal">
                                <button className="group px-6 py-2.5 rounded-xl bg-gray-900 dark:bg-indigo-600 text-white font-bold text-sm transition-all hover:bg-gray-800 dark:hover:bg-indigo-500 hover:shadow-lg active:scale-95 flex items-center gap-2">
                                    <span>Entrar</span>
                                </button>
                            </SignInButton>
                        </SignedOut>
                        ...
                        <SignedIn>
                            <UserButton
                                ...
                                appearance={{
                                    elements: {
                                        avatarBox: "w-10 h-10 border-2 border-white dark:border-slate-800 shadow-sm hover:scale-105 transition-transform"
                                    }
                                }}
                            />
                        </SignedIn>
