...
export default function Header() {
    return (
        <header className="w-full max-w-5xl flex justify-between items-center mb-10 py-4 px-6 bg-white/80 backdrop-blur-md border border-white/20 rounded-2xl shadow-sm sticky top-4 z-50">
            ...
            <div className="flex items-center gap-8">
                ...
                {/* Menu de Navegação (Só aparece se logado) */}
                <SignedIn>
