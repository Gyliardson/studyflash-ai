...
export default function Home() {
    ...
    // --- ESTRATÉGIA DE WAKE UP (Acordar o servidor) ---
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6 md:p-12">
            ...
            <header className="w-full max-w-5xl flex justify-between items-center mb-10">
                ...
                <div>
                    {/* Mostra botão Entrar se NÃO estiver logado */}
                    <SignedOut>
                        <SignInButton mode="modal">
                            <button className="bg-white text-blue-600 px-5 py-2 rounded-lg font-bold shadow-sm hover:bg-blue-50 hover:shadow transition-all border border-blue-100">
                                Entrar
                            </button>
                        </SignInButton>
                    </SignedOut>

                    {/* Mostra Avatar se ESTIVER logado */}
                    <SignedIn>
                        <div className="flex items-center gap-4">
                            <span className="text-sm text-gray-500 hidden sm:block">Olá, estudante!</span>
            ...
            {/* --- CONTEÚDO PRINCIPAL --- */}
            <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500 mb-2 text-center">
                Transforme Texto em Conhecimento
            </h1>
            <p className="text-gray-500 mb-8 text-center max-w-lg">
                Cole seu resumo, artigo ou anotações e deixe a Inteligência Artificial criar seus flashcards de revisão automaticamente.
            </p>
